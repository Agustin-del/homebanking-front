    ...
    <div className=" bg-gray-100">
      <header className="bg-white shadow-lg py-4  h-[15vh] lg:h-[17vh] lg:flex justify-between items-center">
        ...
        <div className=" h-[10px] flex gap-6 items-center justify-center  p-10 w-full">
          <Button className="w-[150px] h-[35px] flex items-center" onClick={() => setLogInOpen(true)}>Login</Button>
          <Button className="w-[150px] h-[35px] flex items-center" onClick={() => setRegisterOpen(true)}>Register</Button>
        </div>
        }
      </header>

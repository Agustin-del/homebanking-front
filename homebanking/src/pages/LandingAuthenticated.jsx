          ...
          : <>
            <div className="flex flex-col justify-evenly flex-1 w-full p-4 gap-4">
              ...
              <div className="flex justify-center flex-col items-center w-full gap-2">
                {creating && <Alert className="w-[380px]" color="info">Creating your account...</Alert>}
                {error && <Alert className="w-[380px]" color="failure">{error}</Alert>}
                <div className="w-[98%] outline">

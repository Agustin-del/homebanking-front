...
const isDesktop = useMediaQuery({minWidth:1024})  
  ...
  switch(color) {
    ...
    return (
      <div className={`card max-h-[170px] max-w-[270px] lg:max-h-[260px] lg:max-w-[400px] flex flex-col justify-end px-6 py-10 text-white rounded-3xl gap-0 lg:gap-8 ${color}`}>
